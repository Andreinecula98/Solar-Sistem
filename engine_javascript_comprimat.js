/*{"k":"0.10.0","mac":"1:ec7bcb36dd14d52ceb6f9d323f094a5b9a58a0892e4d4ebd6026d851e30d2895","version":"409932","created":"2012-02-10T04:26:59Z"}*/
;
(function (window, document, undefined) {
    ...
    G.prototype.watch = function (a, c, b, d) {
        ...
        for (g = 0; g < e; g++) {
            k = a[g];
            d = c[k];
            for (var h = b[k], f = 0, m = d.length; f < m; f++) {
                var n = d[f],
                    p = this.A,
                    i = k,
                    l = n;
                p.c.appendClassName(p.j, p.l.k(p.n, i, l, "loading"));
                F(p, "fontloading", i, l);
                p = u(this, this.za);
                i = u(this, this.Aa);
    ...
    function ka(a, c, b) {
        for (var d = [], e = a.B.split(",")[0].replace(/"|'/g, ""), g = a.w(), k, h = [], f = {}, m = 0; m < g.length; m++) {
            k = g[m];
            if (k.length > 0 && !f[k]) {
                f[k] = j;
                h.push(k)
    ...
    t.init = function (a) {
        for (var c = [], b = 0; b < this.K.length; b++) c.push(ja(this.K[b]));
        a.insertInto("head", a.createStyle(c.join("")))
    };
    t.load = function (a, c, b, d) {
        if (this.L) for (var e = pa(this.L, b.getStylesheetFormatId()), g = 0; g < this.m.length; g++) ka(this.m[g], b, e);
        if (this.z && this.V) {
            this.z.va(new qa(b.getStylesheetFormatId()));
            g = new ra(a, this.F, this.m);
            e = sa(this.V, b.getStylesheetFormatId(), g);
        ...
        c && a.whenBodyExists(function (k, h, f, m) {
            return function () {
                for (var n = 0; n < k.m.length; n++) k.m[n].watch(h, f, m && n == k.m.length - 1)
            }
        }(this, c, b, d))
    };
    t.collectFontFamilies = function (a, c, b) {
        for (var d = 0; d < this.m.length; d++) la(this.m[d], a, c, b)
    };
    t.performOptionalActions = function (a, c, b) {
        this.P && b.whenBodyExists(function (d, e, g, k) {
            return function () {
                var h = d.P;
                h.ja && na(h, h.ja.buildUrl(k.isHttps()));
                var f = d.P;
                h = d.v;
                if (f.S) {
                    f = f.S.k(h, g, k);
    ...
    V.addBrowser(new P("chrome6plus-linux-osx-win2003-win7plus-winvista-winxp", "d", function (a, c, b, d, e, g, k) {
        ...
        function (f, m, n, p, i, l) {
            ...
            } else return i == "Macintosh" && l == "Unknown" ? j : q
    ...
    V.addBrowser(new P("ie6to8-win2003-win7plus-winvista-winxp", "i", function (a, c, b, d, e, g, k) {
        ...
        if (!h) return q;
        return function (f, m, n, p, i, l, L) {
            if (f == "MSIE") {
                if (f = /([0-9]+.[0-9]+)/.exec(m)) return parseFloat(f[1]) >= 6 && (L === undefined || L < 9);
                return q
            }
        }(a, c, b, d, e, g, k)
    }));
    V.addBrowser(new P("safari-osx", "b", function (a, c, b, d, e, g, k) {
        ...
        if (!h) return q;
        return function (f, m, n, p, i) {
            if (f == "Safari" && n == "AppleWebKit" || f == "Unknown" && n == "AppleWebKit" && (i == "iPhone" || i == "iPad")) if (f = /([0-9]+.[0-9]+)/.exec(p)) return parseFloat(f[1]) >= 525.13;
            return q
        }(a, c, b, d, e, g, k)
    }));
    V.addBrowser(new P("safari-android-ipad-win2003-win7plus-winvista-winxp", "a", function (a, c, b, d, e, g, k) {
        var h = q;
        h = (h = (h = (h = (h = (h = h || (e == "Windows" && g == "5.1" ? j : q)) || (e == "Windows" && g == "5.2" ? j : q)) || (e == "Windows" && g == "6.0" ? j : q)) ||
        function (f, m, n, p, i, l) {
            f = /^([0-9]+).([0-9]+)/.exec(l);
        ...
        function (f, m, n, p, i, l) {
            if (i == "iPad") if (m = /^([0-9]+)_([0-9]+)/.exec(l)) {
                f = parseInt(m[1], 10);
                m = parseInt(m[2], 10);
                return f > 4 || f == 4 && m >= 2
            } else return q;
    ...
    var W = new function () {
        ...
        wa = new T("AllFonts", function (a, c) {
            return c
        });
    U(W, wa.getName()) || W.G.push(wa);
    var xa = new T("DefaultFourFontsWithSingleFvdFamilies", function (a, c, b) {
    ...
    if (!window.Typekit) {
        var ya = new O(j, "use.typekit.com", "/"),
            za = (new x(navigator.userAgent, document)).parse(),
            Aa = new M(document, za),
            Ba = function (a, c) {
                setTimeout(a, c)
            },
            Y = new R(ya, Aa, za, document.documentElement, Ba),
            Z = new S(window, Aa, Ba);
        window.Typekit = Y;
        window.Typekit.load = Y.load;
        window.Typekit.addKit = Y.I
    }
    var Ca, Da, $;
    Ca = new O(j, "use.typekit.com", "/k");
    ...
    $ = new oa("atk2dqn");
    $.setSecurityToken("3bb2a6e53c9684ffdc9a9afe195b2a6290e57de54ffd90397ef00dfc11b552d72b1976ef6f77d1baac093d028c55a78a841e3c87a9925a0f0492614cbfa055eafd681b12d03381e18ad6aeae088f9a8b8e9924");
    $.setNestedUrl(Ca);
    $.setKitOptions(Da);
    $.addFontFamily(new N("proxima-nova-extra-condensed-1,proxima-nova-extra-condensed-2", ["n6"]));
    $.addCssRule(new function (a, c) {
        this.La = a;
        this.X = c
    }([".tk-proxima-nova-extra-condensed", "H1", "H2", "li"], [{
        name: "font-family",
        value: '"proxima-nova-extra-condensed-1","proxima-nova-extra-condensed-2","Helvetica Neue","Helvetica","Sans-serif"'
    }]));
    ...
    $.addBrowser(V.getBrowserById("safari-android-ipad-win2003-win7plus-winvista-winxp"));
...
window.TypekitConfig = {
    "p": "//p.typekit.net/p.gif?s=1&k=atk2dqn&ht=tk&h={host}&f=164&a=22177&_={_}"
}
/*{"k":"0.13.2","created":"2012-04-27T00:11:54Z","mac":"1:b33ffc4d6f2b61df59ab68e6c6e83312a8daa4273d951cc90539f0ed8a454a26"}*/;
(function (window, document, undefined) {
    function d(a, b) {
        this.a = a;
        this.d = b
    }
    d.prototype = function (a, b) {
        this.a = a;
        this.d = b
    }.prototype;
    ...
    function k() {
        if (!j) {
            ...
            if (a.length > 0) if (a[a.length - 1].getAttribute("href").indexOf("use.typekit") >= 0) {
                if (i.b) {
                    a = h.a.location.hostname;
                    var b = window.__adobewebfontsappname__;
                    b = b ? b.toString().substr(0, 20) : "";
                    var c = (+new Date).toString();
                    e(i, f(i.b, h.a.location.protocol == "https:", {
                        host: a,
                        app: b,
                        _: c
                    }))
    ...
    var n = window.Typekit.load;
    window.Typekit.load = function () {
        n && n.apply(window.Typekit, arguments);
        k()
    };
    window.__webfonttypekitmodule__ && k();
})(this, document);